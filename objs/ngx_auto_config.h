#define NGX_CONFIGURE " --prefix=/usr/local/nginx_babssl_1.1 --add-module=../modules_nginx_babassl --with-openssl=/root/BabaSSL-8.3.1 --with-openssl-opt='--strict-warnings enable-ntls' --with-http_ssl_module --with-stream --with-stream_ssl_module"
...
#ifndef T_NGX_SSL_NTLS
#define T_NGX_SSL_NTLS  1
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/usr/local/nginx_babssl_1.1/"
#endif
